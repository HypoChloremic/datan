...
class w_o_p_y_w:
    def __init__(self, list_of_XY_coordinates=None, order=None, **kw):
        pass
    #We note the length of the input list so that we do not have to compute it again
    lengthOfList = len(list_of_XY_coordinates)
    ...
    #I turn it into a simple list witht the folowing for loop.
    solution = []
